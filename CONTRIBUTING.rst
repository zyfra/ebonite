...
When `reporting a bug <https://github.com/zyfra/ebonite/issues>`_ please include:
...
ebonite could always use more documentation, whether as part of the
official ebonite docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork `ebonite <https://github.com/zyfra/ebonite>`_
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Github Actions - it will
       `run the tests <https://github.org/zyfra/ebonite/actions>`_ for each change you add in the pull request.
